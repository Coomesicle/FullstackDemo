        ...
        <div className="mx-auto max-w-6xl space-y-4">
          <div className="flex items-center space-x-4">
            <form className="flex items-center space-x-4">
              ...
              <Input
                className="w-[200px] md:w-[300px] lg:w-[400px] xl:w-[500px] 2xl:w-[600px]"
                id="search"
                placeholder="Search for candy requests..."
                type="search"
              />
              <Button type="submit">Search</Button>
            </form>
          </div>
          <div className="mt-4 border border-gray-200 rounded-lg dark:border-gray-800">
            <Table>
              <TableHeader>
                <TableRow>
